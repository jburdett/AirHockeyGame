...
namespace Project
{
    public class GameInput
    {
        ...
        public GameInput()
        {
            ...
            gestureRecognizer.GestureSettings = GestureSettings.ManipulationTranslateX | GestureSettings.ManipulationTranslateY | GestureSettings.ManipulationScale | GestureSettings.Tap;
